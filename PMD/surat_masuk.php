...
// Menyusun SQL query dengan kondisi pencarian dan pagination
$sql = "SELECT * FROM surat_masuk WHERE nomor_surat LIKE ? OR perihal LIKE ? OR pengirim LIKE ? LIMIT ?, ?";
$stmt = $conn->prepare($sql);
$searchWildcard = "%$searchQuery%";
$stmt->bind_param("sssss", $searchWildcard, $searchWildcard, $searchWildcard, $offset, $limit);
$stmt->execute();
$result = $stmt->get_result();

// Menghitung jumlah total data
$totalSql = "SELECT COUNT(*) as total FROM surat_masuk WHERE nomor_surat LIKE ? OR perihal LIKE ? OR pengirim LIKE ?";
$totalStmt = $conn->prepare($totalSql);
$totalStmt->bind_param("sss", $searchWildcard, $searchWildcard, $searchWildcard);
$totalStmt->execute();
