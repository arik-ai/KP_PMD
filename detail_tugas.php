...
if (isset($_GET['id'])) {
    ...
    // Query untuk mendapatkan detail surat perjanjian tugas dan username penginput
    $sql = "SELECT surat_tugas.*, users.username 
            FROM surat_tugas 
            LEFT JOIN users ON surat_tugas.tugas_input = users.id
            WHERE surat_tugas.id_tugas = ?";
...
<head>
    ...
    <title>Detail Surat Perjanjian tugas</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <h2>Detail Surat Perjanjian tugas</h2>
            <table class="table">
                <tr>
                    <th>No. Surat</th>
                ...
                <tr>
                    ...
                    <td><?= empty($row['dokumen_tugas']) ? 'Belum Upload' : 'Sudah Upload'; ?></td>
                </tr>
                <tr>
                    <th>Penginput</th>
            ...
            <a href="surat_tugas.php" class="btn btn-primary">Kembali</a>
        </div>
    </div>
