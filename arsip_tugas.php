...
if (isset($_GET['id'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Data berhasil dihapus!'); window.location.href='surat_perjanjian_tugas.php';</script>";
    } else {
...
if ($searchQuery !== '') {
    $conditions .= "(no_tugas LIKE ? OR perihal_tugas LIKE ?)";
...
// Hitung total data
$totalQuery = "SELECT COUNT(*) AS total FROM surat_tugas WHERE (no_tugas LIKE ? OR perihal_tugas LIKE ?) AND $conditions";
...
$sql = "SELECT * FROM surat_tugas WHERE (no_tugas LIKE ? OR perihal_tugas LIKE ?) AND $conditions LIMIT ? OFFSET ?";
$stmt = $conn->prepare($sql);
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="surat_perjanjian_tugas.php" ><span class="icon">📜</span> Surat Perjanjian tugas</a></li>
    ...
    <div class="main-content">
        ...
        <div class="container">
            ...
            <div class="search-bar">
                <form action="arsip_tugas.php" method="GET">
                    ...
                    <?php if ($result->num_rows > 0): ?>
                        <?php $no = $offset + 1; while ($row = $result->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?= htmlspecialchars($row['dokumen_tugas']); ?></td>
                            </tr>
                        <?php endwhile; ?>
                    <?php else: ?>
                        <tr>
            ...
            <div class="export-buttons">
                <a href="export_arsip_tugas.php?search=<?= urlencode($searchQuery); ?>&year=<?= $filterYear; ?>&month=<?= $filterMonth; ?>" class="btn btn-success">Export ke Excel</a>
            </div>
        </div>
    </div>
</body>
