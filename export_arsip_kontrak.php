...
if ($searchQuery !== '') {
    $conditions .= " AND (no_kontrak LIKE ? OR perihal_kontrak LIKE ? OR tgl_kontrak LIKE ? OR dokumen_kontrak LIKE ?)";
...
if ($filterYear) {
    $conditions .= " AND YEAR(tgl_kontrak) = ?";
...
header("Content-Disposition: attachment; filename=Arsip_Surat_Perjanjian_Kontrak.xls");
