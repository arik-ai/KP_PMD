...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT surat_kontrak.*, users.username 
            FROM surat_kontrak 
            LEFT JOIN users ON surat_kontrak.kontrak_input = users.id
            WHERE surat_kontrak.id_kontrak = ?";
...
<head>
    ...
    <title>Detail Surat Perjanjian Kontrak</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <h2>Detail Surat Perjanjian Kontrak</h2>
            <table class="table">
                <tr>
                    <th>No. Surat</th>
                ...
                <tr>
                    ...
                    <td><?= empty($row['dokumen_kontrak']) ? 'Belum Upload' : 'Sudah Upload'; ?></td>
                </tr>
                <tr>
                    <th>Penginput</th>
            ...
            <a href="surat_perjanjian_kontrak.php" class="btn btn-primary">Kembali</a>
        </div>
    </div>
